package com.bank.bian.securitieslending.model;
...
/**
 * The BIAN control record for this service domain: "Securities Loan Fulfillment Arrangement".
 *
 ...
 * to its asset type (Securities Loan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Securities Loan Fulfillment Arrangement";
